...
public class MethodCallExpression extends Expression {
     ...
     *         the method referenced by this call, if already
     ...
     * expression to the abstract syntax for its <tt>receiver</tt>,
     ...
     * method for the call. It returns the return type of the static target
     * method.
     *
	...
	if (!(receiverType instanceof ClassType))
		...
		return (method = (MethodSignature)methods.iterator().next())
		    .getReturnType();
	}
    }
