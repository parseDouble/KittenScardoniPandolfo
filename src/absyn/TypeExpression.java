...
public abstract class TypeExpression extends Absyn {
     ...
     * by the type-checker. It is <tt>null</tt> if this-checking
     ...
     * if it has already been computed by a type-checker.
     *
     ...
     * <tt>typeCheck$0</tt> and stores the resulting semantical type
     * into the field <tt>staticType</tt>.
     *
     * @return the semantical type corresponding to this type expression
     */

    public final Type typeCheck() {
	return staticType = typeCheck$0();
    }
     ...
     * It calls the auxiliary method
     * <tt>toType$0</tt> and stores the resulting semantical type
     * into the field <tt>staticType</tt>. The difference with
     * <tt>typeCheck()</tt> is that class types occurring in this type
	...
	return staticType = toType$0();
    }

    /**
     * Auxiliary method which yields the semantical type corresponding
     * to this type expression. The difference with
     * <tt>typeCheck$0()</tt> is that class types occurring in this type
     * expressions are not type-checked themselves.
     *
     * @return the semantical type corresponding to this type expression
     */

    protected abstract Type toType$0();

    /**
     * Returns the static semantical
     * type of this type expression, as computed during
     * last type-checking.
     *
    ...
    /**
     * Yields a <tt>String</tt> representing this type expression.
     *
     * @return the <tt>String</tt> representing this type expression
     */
