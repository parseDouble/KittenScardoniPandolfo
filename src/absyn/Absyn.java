...
public abstract class Absyn {
    ...
    /**
     * A type error which occurred in this node of abstract syntax
	...
	// we get the Java class of <tt>this</tt> and we extract the
	// name of this run-time class. If a type-error occurred in this
	...
	// we use the unique identifier in order to avoid confusion
	return "node" + identifier;
    }

    /**
     * Writes in a dot file a labelled arc between the node for this abstract
     * syntax and that specified as a parameter.
     *
     * @param name the label of the arc
     * @param to the name of the destination of the arc, as used
     *           in the dot file
     * @param where the dot file where this arc should be written
     */

    protected final void linkToNode
	(String name, String to, FileWriter where) throws java.io.IOException
    {
    ...
    /**
     * Writes in a dot file a bold labelled arc
