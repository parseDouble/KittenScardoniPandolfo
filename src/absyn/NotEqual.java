...
/**
 * A node of abstract syntax representing an non-equality test between
 * two expressions.
 *
...
public class NotEqual extends ComparisonBinOp {
    ...
    /**
     * Constructs the abstract syntax of a non-equality test between
     * two expressions.
     *
    ...
    /**
     * Performs the type-checking of a non-equality test between
     * two expressions.
